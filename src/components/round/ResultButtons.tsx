...
const BUTTONS: ButtonDef[] = [
  ...
  {
    result: "forfeit_white",
    icon: MdDirectionsRun as typeof Trophy,
    label: "Abandona blancas",
    side: "white",
  },
  { result: "draw", icon: Handshake, label: "Tablas", side: "center" },
  {
    result: "forfeit_black",
    icon: MdDirectionsRun as typeof Trophy,
    label: "Abandona negras",
    side: "black",
  },
...
export function ResultButtons({ current, onChange }: ResultButtonsProps) {
  ...
  return (
    <div className="mt-2 flex items-center justify-between gap-2">
      ...
      <div className="flex items-center">{renderButton(centerButton)}</div>
      <div className="flex items-center gap-1">
